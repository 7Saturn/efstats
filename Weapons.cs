...
namespace EfStats {
    public class Weapons {
        public static readonly string[] weaponNames = {
            ...
            "Teleporter",                            //  5 MOD_TELEFRAG             = WP_NONE = Teleporter spawn
        ...
        private static readonly List<uint> WorldDamageIDs = new List<uint> {
            0, 1, 2, 3, 4, 6, 7, 8, 9, 41, 42 //WP_NONE values, TELEFRAG is /no/ one of those, the emergency transporter may not be designed as a weapon but can have the same effect. It's /not/ a part of the map.
        };
