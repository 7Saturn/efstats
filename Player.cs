...
public class Player {
    ...
    public Player(string newNickName, bool newIsBot) {
    ...
    public override bool Equals(object otherGuy) {
        ...
        //Console.WriteLine(otherGuy.ToString() + " == " + ToString() + "?");
    ...
    public static int Compare(Player a, Player b) {
        if (a.getElo().Equals(b.getElo())) return 0;
        if (a.getElo() > b.getElo()) return 1;
        return -1;
    }
    ...
    public string getDetails(bool noColors) {
        ...
        Incident worstIncidence = getWorstEnemy();
        uint worstEnemyCounter = worstIncidence.counter;
        string worstEnemyString = worstIncidence.name + "(" + worstEnemyCounter + ")";

        Incident easiestIncidence = getEasiestEnemy();
        uint easiestEnemyCounter = easiestIncidence.counter;
        string easiestEnemyString = easiestIncidence.name + "(" + easiestEnemyCounter + ")";
        return outNick
            + ":Bot=" + isBot
            + ":K=" + kills
            + ":D=" + deaths
            ...
            + ":attackers=" + attackers
            + ":victims=" + victims
            + ":WorstEnemy=" + worstEnemyString
            + ":EasiestTarget=" + easiestEnemyString;
    }
    ...
    public Incident getEasiestEnemy() {
